...
<div class="row">
    <div class="form-group">
        <label for="content" class="control-label sr-only">
            Content
        </label>
        <div class="col-md-10 col-md-offset-1" >
            <textarea class="form-control my-editor" name="content" rows="20" id="content" placeholder="Please write down your content here...">{{ $content }}</textarea>
